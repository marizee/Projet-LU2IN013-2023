...
Nous avons fait ce choix pour obtenir un contexte exacte et facilement représentable en machine. 
...
\textit{
\begin{itemize}
    \item Le graphe ci-dessus nous montre l'allure cubique de la courbe de l'algorithme naif qui a une complexité moins optimale que celui de Karatsuba qui présente une allure quadratique. 
