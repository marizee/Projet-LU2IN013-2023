...
De même, la généralisation de la composition modulaire à $g$ bivarié avec l'algorithme de Nüsken et Ziegler n'était pas encore implémanté dans la bibliothèque NTL. Pour aller plus loin, nous avons donc essayé une première implantation.
